...
class TestSampleModel:
    ...
    def test_normalize_detailed_balance_setter_raises_with_invalid_type(
        self, sample_model
    ):
        # WHEN / THEN / EXPECT
        with pytest.raises(
    ...
    def test_evaluate_calls_dbf(self, sample_model):
        ...
        with patch(
            "easydynamics.sample_model.sample_model.detailed_balance_factor"
        ) as mock_dbf:
