...
class TestConvolutionSettings:
    ...
    def test_init(self, default_convolution_settings):
        ...
        assert default_convolution_settings.normalize_detailed_balance is True
    ...
    def test_init_with_custom_parameters(self):
        ...
        assert convolution_settings.normalize_detailed_balance is False
        assert convolution_settings.convolution_plan_is_valid is False

    @pytest.mark.parametrize(
        'invalid_input, expected_exception, match',
        [
            ({'normalize_detailed_balance': 'yes'}, TypeError, 'must be True or False'),
        ...
        ids=[
            'normalize_detailed_balance_not_bool',
    ...
    def test_normalize_detailed_balance_setter_valid(
        self,
        default_convolution_settings,
        value,
    ):
        # WHEN
        default_convolution_settings.normalize_detailed_balance = not value

        # THEN
        default_convolution_settings.normalize_detailed_balance = value

        # EXPECT
        assert default_convolution_settings.normalize_detailed_balance is value
    ...
    def test_normalize_detailed_balance_setter_invalid(
        self,
        default_convolution_settings,
        value,
        expected_exception,
    ...
    def test_repr_reflects_updated_values(self, default_convolution_settings):
        ...
        default_convolution_settings.normalize_detailed_balance = False
