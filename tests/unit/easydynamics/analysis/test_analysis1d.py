...
class TestAnalysis1d:
    ...
    def test_fit_calls_fitter_with_correct_arguments(self, analysis1d):
        ...
        analysis1d.experiment._extract_x_y_weights = MagicMock(
        ...
        analysis1d.experiment._extract_x_y_weights.assert_called_once()
    ...
    def test_evaluate_with_resolution(self, analysis1d):
        ...
        with patch("easydynamics.analysis.analysis1d.Convolution") as MockConvolution:
            ...
            energy_offset = analysis1d.instrument_model.get_energy_offset_at_Q(
                analysis1d.Q_index
            )
    ...
    def test_create_convolver(self, analysis1d):
        ...
        analysis1d.instrument_model.get_energy_offset_at_Q = MagicMock(
            return_value=123.0
        )
