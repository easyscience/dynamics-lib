...
class TestFitTarget:
    def test_fit_target_holds_prediction_metadata(self):
    ...
    def test_fit_target_allows_none_key_and_units(self):
    ...
    def test_fit_target_is_frozen(self):
        # WHEN
        target = FitTarget(
            name='value',
            dataset_key=None,
